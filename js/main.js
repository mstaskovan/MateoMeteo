...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // =======================================================
    // ZMENA: Úprava hlavičky a zobrazených hodnôt v tabuľke
    // =======================================================
        ...
        data.forEach(item => {
            ...
            if (mode === 'hourly') {
                ...
                tableHTML += `<tr>
                    ...
                    <td>${f(item.rainTotal)}</td><td>${f(item.srAvg, 0)}</td><td>${f(item.uvAvg)}</td>
                </tr>`;
            }
        });
